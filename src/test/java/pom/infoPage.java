...
public class infoPage extends BasePage{
    ...
    public void finalizarBooking(String texto, String tc, String te,String mensajeErrorTarjeta, String mensajeErrorTCExpiracion) throws Exception {
        try {
            ...
            click(input_card);
            if (isDisplayed(error_expiry_date) && getText(error_expiry_date).equals(mensajeErrorTCExpiracion)){
                textEquals(mensajeErrorTarjeta,error_card);
            }else {
                Thread.sleep(2000);
                textEquals(getPriceTotal(),label_priceTotal);
